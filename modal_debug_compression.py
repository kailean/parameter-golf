#!/usr/bin/env python3
"""Run compression debug on Modal — print directly to stdout."""
import modal
import os
import sys

app = modal.App("compression-debug")
...
def debug():
    ...
    # Code size
    code_path = "/root/train_gpt_kl.py"
    ...
    return total_params, total_payload, len(raw_pickle), len(brotli_plain), len(brotli_shuf2), len(brotli_shuf4), submission, fits
