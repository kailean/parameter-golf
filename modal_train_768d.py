...
app = modal.App("parameter-golf-omniclaw-768d")
...
def train():
    ...
    env = {
        **os.environ,
        ...
        "NUM_HEADS": "12",
        "NUM_KV_HEADS": "6",
        "MLP_MULT": "4",                    # ~74M params → ~12-15MB mixed int8/int6+brotli
        "TIE_EMBEDDINGS": "1",
        ...
        "LOGIT_SOFTCAP": "30.0",
        "SEED": "1337",
        # Training schedule — no wallclock cap, run to 3000 steps
        "ITERATIONS": "3000",
        ...
        "EMA_DECAY": "0.9965",
        "EMA_START_FRAC": "0.5",
        "USE_SWA": "1",                     # Stochastic Weight Averaging — wider optima
